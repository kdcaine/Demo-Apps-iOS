...
class ScanCommandController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "segueEAN" {
            let successVC = segue.destination as! ListeCommandeController
            successVC.codeEAN = codeArticleScanne
        }
    }
    ...
    func launchApp(codeArticle: String) {
        ...
        performSegue(withIdentifier: "segueEAN", sender: self)
        ...
        let nextViewController = storyBoard.instantiateViewController(withIdentifier: "list_command")
